...
final class GtmItemFactoryFromOrderItemTest extends TestCase
{
    ...
    public function testCreateNewFromProductVariantIncludesProductData(): void
    {
    ...
    public function testCreateNewFromProductVariantUsesCodeWhenNameIsNull(): void
    {
        $product = $this->createMock(ProductInterface::class);
        $product->method('getName')->willReturn('Test Product');
        $product->method('getMainTaxon')->willReturn(null);
    ...
    public function testCreateNewFromProductVariantWithoutVariantInfoOmitsItemVariant(): void
    {
        $product = $this->createMock(ProductInterface::class);
        $product->method('getName')->willReturn('Test Product');
        $product->method('getMainTaxon')->willReturn(null);
    ...
    public function testCreateNewFromProductVariantIncludesTaxonData(): void
    {
